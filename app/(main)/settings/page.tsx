...
export default function SettingsPage() {
  ...
  useEffect(() => {
    ...
    if (success === "calendar_connected") {
      ...
      let errorMessage = "구글 캘린더 연결 중 오류가 발생했습니다.";
      switch (error) {
        case "missing_params":
          errorMessage = "인증 정보가 누락되었습니다. 다시 시도해주세요.";
          break;
        case "no_refresh_token":
          errorMessage = "리프레시 토큰을 받지 못했습니다. 다시 시도해주세요.";
          break;
        case "unauthorized":
          errorMessage = "인증에 실패했습니다. 다시 로그인해주세요.";
          break;
        case "update_failed":
          errorMessage = "연결 정보 저장에 실패했습니다. 다시 시도해주세요.";
          break;
        case "config_error":
